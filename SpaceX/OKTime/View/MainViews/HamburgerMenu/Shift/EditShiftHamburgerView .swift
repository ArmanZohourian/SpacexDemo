        ...
        ActionSheetView {
            ScrollView {
                VStack(alignment: .trailing ,spacing: 10) {
                    ...
                    Button {
                        Task {
                            await getShiftViewModel.editShift(startDate: startTime.getFormattedDate(format: "HH:mm:ss"), endDate: endTime.getFormattedDate(format: "HH:mm:ss"), shiftDuration: shiftDuration.getFormattedDate(format: "HH:mm:ss"), shiftTitle: shiftTitle, days: selectedDays, currentShift:  getShiftViewModel.currentShift!, completionHandler: {isSuccessful in
                                if isSuccessful {
                                    isPresented.toggle()
                                }
                            })
                ...
                .popup(isPresented: $getShiftViewModel.hasError) {
