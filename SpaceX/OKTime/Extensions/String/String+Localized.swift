...
/// An Extension for string so that all the texts all over the can be converted
/// to the desired and set language of the app
/// Usage : "some text".localized(language)
extension String {
